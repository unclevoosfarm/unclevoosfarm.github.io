...
const translations = {
  en: {
    ...
    langLabel: 'Language',
    // Features section
    featuresTag: "Why Uncle Voo's Farm",
    featuresTitle: 'Reconnect with nature and enjoy the simple pleasures.',
    featuresSubtitle: "Whether you're looking for a weekend escape, fresh ingredients for your dinner, or a learning experience for your kids, Uncle Voo's Farm offers a unique connection to the land.",
    featuresEcoTitle: 'Eco-Friendly',
    featuresEcoDesc: 'Sustainable practices in everything we do.',
    featuresOrganicTitle: 'Certified Organic',
    featuresOrganicDesc: '100% pesticide-free produce for your health.',
    featuresFamilyTitle: 'Family Friendly',
    featuresFamilyDesc: 'Safe activities for visitors of all ages.',
    featuresFarm2TableTitle: 'Farm to Table',
    featuresFarm2TableDesc: 'Delivered fresh from our fields to your door.',
    // Quick Cards
    quickStayTitle: 'Cozy Stays',
    quickStayDesc: 'Rustic cabins with modern amenities for the perfect countryside getaway.',
    quickStayLink: 'Check Availability',
    quickHarvestTitle: 'Daily Harvest',
    quickHarvestDesc: 'Visit our shop for fresh eggs, milk, and seasonal vegetables picked today.',
    quickHarvestLink: 'Browse Products',
    quickToursTitle: 'Farm Tours',
    quickToursDesc: 'Explore our working farm with guided tours. Feed the animals, pick fresh fruit, and learn about sustainable farming.',
    quickToursLink: 'Book a Tour',
    // Footer nav
    footerHome: 'Home',
    footerNavStay: 'Farm Stay',
    footerNavShop: 'Harvest Shop',
    footerNavTours: 'Farm Tours',
    footerNavReviews: 'Reviews',
    footerNavContact: 'Contact',
    footerCopyrightText: "\u00a9 2026 Uncle Voo's Farm. All rights reserved.",
  },
  my: {
    // Header
    navStay: 'Penginapan',
    ...
    langLabel: 'Bahasa',
    // Features section
    featuresTag: 'Mengapa Ladang Uncle Voo',
    featuresTitle: 'Hubungkan semula dengan alam dan nikmati kesenangan hidup.',
    featuresSubtitle: 'Sama ada anda mencari pelarian hujung minggu, bahan segar untuk makan malam, atau pengalaman pembelajaran untuk anak-anak, Ladang Uncle Voo menawarkan hubungan unik dengan alam.',
    featuresEcoTitle: 'Mesra Alam',
    featuresEcoDesc: 'Amalan lestari dalam segala yang kami lakukan.',
    featuresOrganicTitle: 'Organik Bersijil',
    featuresOrganicDesc: '100% bebas racun perosak untuk kesihatan anda.',
    featuresFamilyTitle: 'Mesra Keluarga',
    featuresFamilyDesc: 'Aktiviti selamat untuk pengunjung semua peringkat umur.',
    featuresFarm2TableTitle: 'Ladang ke Meja',
    featuresFarm2TableDesc: 'Dihantar segar dari ladang kami terus ke pintu anda.',
    // Quick Cards
    quickStayTitle: 'Penginapan Selesa',
    quickStayDesc: 'Kabin bergaya dengan kemudahan moden untuk percutian luar bandar yang sempurna.',
    quickStayLink: 'Semak Ketersediaan',
    quickHarvestTitle: 'Tuaian Harian',
    quickHarvestDesc: 'Lawati kedai kami untuk telur segar, susu, dan sayur-sayuran bermusim yang dipetik hari ini.',
    quickHarvestLink: 'Semak Produk',
    quickToursTitle: 'Lawatan Ladang',
    quickToursDesc: 'Terokai ladang kami yang aktif dengan lawatan berpandu. Beri makan haiwan, petik buah segar, dan pelajari pertanian lestari.',
    quickToursLink: 'Tempah Lawatan',
    // Footer nav
    footerHome: 'Utama',
    footerNavStay: 'Penginapan Ladang',
    footerNavShop: 'Kedai Tuaian',
    footerNavTours: 'Lawatan Ladang',
    footerNavReviews: 'Ulasan',
    footerNavContact: 'Hubungi',
    footerCopyrightText: '\u00a9 2026 Uncle Voo\'s Farm. Hak cipta terpelihara.',
  },
  zh: {
    // Header
    navStay: '\u4f4f\u5bbf',
    ...
    langLabel: '\u8bed\u8a00',
    // Features section
    featuresTag: '\u4e3a\u4f55\u9009\u62e9Uncle Voo\u519c\u573a',
    featuresTitle: '\u91cd\u65b0\u4e0e\u5927\u81ea\u7136\u8fde\u63a5\uff0c\u4eab\u53d7\u751f\u6d3b\u7684\u7b80\u5355\u4e50\u8da3\u3002',
    featuresSubtitle: '\u65e0\u8bba\u60a8\u662f\u5bfb\u627e\u5468\u672b\u5ea6\u5047\u3001\u9910\u684c\u65b0\u9c9c\u98df\u6750\uff0c\u8fd8\u662f\u4e3a\u5b69\u5b50\u5bfb\u627e\u5b66\u4e60\u4f53\u9a8c\uff0cUncle Voo\u519c\u573a\u90fd\u80fd\u8ba9\u60a8\u4e0e\u5927\u5730\u5efa\u7acb\u72ec\u7279\u7684\u8054\u7cfb\u3002',
    featuresEcoTitle: '\u73af\u4fdd\u53cb\u597d',
    featuresEcoDesc: '\u6211\u4eec\u5728\u6bcf\u4ef6\u4e8b\u4e0a\u90fd\u8df5\u884c\u53ef\u6301\u7eed\u53d1\u5c55\u7406\u5ff5\u3002',
    featuresOrganicTitle: '\u6709\u673a\u8ba4\u8bc1',
    featuresOrganicDesc: '100%\u65e0\u519c\u836f\u4ea7\u54c1\uff0c\u4e3a\u60a8\u7684\u5065\u5eb7\u4fdd\u9a7e\u62a4\u822a\u3002',
    featuresFamilyTitle: '\u5bb6\u5ead\u53cb\u597d',
    featuresFamilyDesc: '\u9002\u5408\u6240\u6709\u5e74\u9f84\u5c42\u8bbf\u5ba2\u7684\u5b89\u5168\u6d3b\u52a8\u3002',
    featuresFarm2TableTitle: '\u519c\u573a\u5230\u9910\u684c',
    featuresFarm2TableDesc: '\u4ece\u6211\u4eec\u7684\u7530\u5730\u76f4\u63a5\u65b0\u9c9c\u9001\u5230\u60a8\u7684\u95e8\u53e3\u3002',
    // Quick Cards
    quickStayTitle: '\u8212\u9002\u4f4f\u5bbf',
    quickStayDesc: '\u5e26\u6709\u73b0\u4ee3\u8bbe\u65bd\u7684\u4e61\u6751\u5c0f\u5c4b\uff0c\u5b8c\u7f8e\u7684\u4e61\u6751\u5ea6\u5047\u4f53\u9a8c\u3002',
    quickStayLink: '\u67e5\u770b\u7a7a\u623f',
    quickHarvestTitle: '\u6bcf\u65e5\u6536\u83b7',
    quickHarvestDesc: '\u6765\u6211\u4eec\u7684\u5546\u5e97\u8d2d\u4e70\u4eca\u5929\u65b0\u9c9c\u91c7\u6458\u7684\u9e21\u86cb\u3001\u725b\u5976\u548c\u65f6\u4ee4\u84d4\u83dc\u3002',
    quickHarvestLink: '\u6d4f\u89c8\u4ea7\u54c1',
    quickToursTitle: '\u519c\u573a\u6e38\u89c8',
    quickToursDesc: '\u8ddf\u968f\u5bfc\u6e38\u63a2\u7d22\u6211\u4eec\u7684\u519c\u573a\u3002\u5582\u517b\u52a8\u7269\u3001\u91c7\u6458\u65b0\u9c9c\u6c34\u679c\uff0c\u4e86\u89e3\u53ef\u6301\u7eed\u519c\u4e1a\u3002',
    quickToursLink: '\u9884\u7ea6\u6e38\u89c8',
    // Footer nav
    footerHome: '\u9996\u9875',
    footerNavStay: '\u519c\u573a\u4f4f\u5bbf',
    ...
    footerCopyrightText: '\u00a9 2026 Uncle Voo\'s Farm\u3002\u7248\u6743\u6240\u6709\u3002',
  },
};
